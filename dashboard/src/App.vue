<template>
  <!--
    App.vue — Layout Shell หลักของทั้ง App
    ────────────────────────────────────────
    ทุกหน้าจะมี AppHeader + AppNav + footer เหมือนกัน
    เนื้อหาของแต่ละหน้าแสดงผ่าน <RouterView />

    เพิ่มหน้าใหม่: แก้ router/index.js และ AppNav จะอัพเดตเอง
  -->
